...
public class FPlayer extends PlayerEntity implements RelationParticipator {
...
//        System.out.println(Conf.chatTagFormat + "~~~~~~~~~~");//chatTagFormat
//        System.out.println(this.role.getPrefix() + " @@@@@@@@@ "+ this.getTag());
    ...
    protected void updatePower() {
        ...
        if (thisPlayer != null && thisPlayer.getHealth() <= 0)
    ...
    public void leave(boolean makePay) {
        ...
        Server.getInstance().getPluginManager().callEvent(leaveEvent);
    ...
    public boolean attemptClaim(Faction forFaction, Location location, boolean notifyFailure) {
        ...
        Server.getInstance().getPluginManager().callEvent(claimEvent);
